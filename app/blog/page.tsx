...
export const metadata = {
  title: "Blog - CourseMind",
  description: "Read the latest articles, tips, and insights about AI-powered learning, course creation, and education technology.",
};
      ...
      <section className="bg-gradient-to-br from-primary/10 via-primary/5 to-background py-16">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Insights on AI-powered learning, course creation, and the future of education
          </p>
        </div>
      </section>
